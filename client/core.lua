...
Citizen.CreateThread(function()
    ...
    for k, v in pairs(Fuels) do
        if GetResourceState(v.ResourceName) == "starting" or GetResourceState(v.ResourceName) == "started" then
            ...
            function GetFuel(vehicle) v.GetFuel(vehicle) end
        end
    end
    for k, v in pairs(Keys) do
        if GetResourceState(v.ResourceName) == "starting" or GetResourceState(v.ResourceName) == "started" then
            function GiveKey(vehicle, plate) v.GiveKey(vehicle, plate) end
        end
    end
end)
...
function TriggerCallback(name, cb, ...)
    ...
    TriggerServerEvent('exter-garage:server:triggerCallback', name, ...)
end

RegisterNetEvent('exter-garage:client:triggerCallback', function(name, ...)
...
function SetVehicleProperties(vehicle, props)
    if GetResourceState('av_tuning') == "starting" or GetResourceState('av_tuning') == "started" then
